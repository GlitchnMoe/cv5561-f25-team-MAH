...
def preprocess_face(frame, box):
    ...
    box: (x, y, w, h) from Haar Cascade
    returns: face image as float32 array, shape (H, W, 3), values in [0, 1]
    """
    x, y, w, h = box

    # Safety clamp in case box goes outside frame bounds
    ...
    # Convert BGR -> RGB (most DL models expect RGB)
...
def main():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            age, gender, expr = dummy_predict(face_arr)
